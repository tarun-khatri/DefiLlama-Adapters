const vaultAbi = {
  "wantToken": "address:wantToken",
  "totalVaultFunds": "uint256:totalVaultFunds",
  "executorByIndex": "function executorByIndex(uint256 _index) view returns (address)",
  "lastEpochYield": "uint256:lastEpochYield"
};
const batcherAbi = {
  "pendingDeposit": "uint256:pendingDeposit"
};
const teAbi = {
  "positionInWantToken": "function positionInWantToken() view returns (uint256 posValue, uint256 lastUpdatedBlock)"
};
const erc4626Abi = {
