...
*/ //we dont support alephium on CEX dashboard
  ...
  /*
  bitcoin: 'nonkyc', // remove it for now
    /*
  bitcoincash: {
    owners: [
  ...
  */
  ...
  methodology: 'All reserves information can be found here https://nonkyc.io/allreserves. Addresses with less than $10 value in assets are not tracked.',
}
